"""add branch field to all questionare related tables

Revision ID: 457f19601bb
Revises: 159de9597b2
Create Date: 2015-06-26 01:54:49.921664

"""

# revision identifiers, used by Alembic.
revision = '457f19601bb'
...
def upgrade():
    ...
    sa.Column('created', sa.Date(), nullable=False),
    sa.Column('branch', guid.GUID(), nullable=False),
    sa.Column('version', sa.Integer(), autoincrement=False, nullable=False),
    sa.Column('changed', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id', 'version')
    )
    ...
    sa.Column('created', sa.Date(), nullable=False),
    sa.Column('title', sa.Text(), nullable=False),
    sa.Column('branch', guid.GUID(), nullable=True),
    sa.Column('version', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
